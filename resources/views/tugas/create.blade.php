    ...
    <div class="min-h-full">
        ...
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <form action="{{ route('tugas.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                    @csrf

                    {{-- proyek --}}
                    <div>
                        <label for="project_id" class="block text-sm font-medium text-gray-700">Choose Project</label>
                        ...
                        @error('project_id') <p class="text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        @error('deadline') <p class="text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="status" id="status"
                            ...
                            @foreach(['to-do', 'in-progress', 'done'] as $status)
                                <option value="{{ $status }}" @selected(old('status', 'to-do') === $status)>
