...
{{-- inii navbarnya aku ganti pake punyaku sendirii dari tailwind, jadinya log out blm kupasanginn sama ui nya masi agak aneh hehe--}}
{{-- kalo cece mau log out yg atas di uncomment ajaa trs yg bwh ini di comment wkwkwk --}}
{{-- trss aku gatau kenapa kadang kalo log out trs log in lagi gabisaa(?) padahal email sama passwordnya udah benerr + template dari breeze ngga aku otak atik--}}
<!DOCTYPE html>
    ...
    <div class="min-h-full">
        ...
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div class="py-12">
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                        <div class="p-4 sm:p-8 bg-gray-800 dark:bg-white shadow sm:rounded-lg">
                            <div class="max-w-xl">
                                @include('profile.partials.update-profile-information-form')
                            </div>
                        </div>
